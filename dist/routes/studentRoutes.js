...
router.post("/studentRegister", studentDependency.studentRegisterController.registerStudent);
router.get("/listCourses", studentDependency.listCoursesController.courseList);
router.patch("/enrolToCourse", studentDependency.courseEnrolController.enrolCourse);
